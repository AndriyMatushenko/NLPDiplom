...
def split_chunks(documents):
    ...
    :param documents: Список документів, отриманих від `scrape_legal_data`.
    :type documents: list[dict]
    :return: Список чанків, де кожен чанк є словником з ключами 'source' та 'chunk_text'.
    :rtype: list[dict]
    """
...
def lemmatize(text):
    ...
    :param text: Вхідний текст для лематизації.
    :type text: str
    :return: Список лематизованих слів.
    :rtype: list[str]
    """
    download_nltk_resources()
...
def process_data():
    ...
    Ця функція є центральною для підготовки даних і викликається,
    якщо файл `documents.pkl` не знайдено.
    """
...
class Search:
    ...
    def query(self, text):
        ...
        :param text: Текстовий запит від користувача.
        :type text: str
        :return: Рядок, що містить об'єднані релевантні чанки, або повідомлення,
...
def generate_answer(context, query_text):
    ...
    :type query_text: str
    :return: Згенерована моделлю відповідь.
    :rtype: str
    """
    prompt = f"""
Контекст:
